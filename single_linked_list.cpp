 ...
 * @LastEditTime: 2024-04-21 23:47:46
...
public:
    ...
    void Clear() noexcept {
        while(head_.next_node != nullptr){
            Node* p_buff = head_.next_node->next_node;
            delete head_.next_node;
            head_.next_node = p_buff;
    ...
    Iterator EraseAfter(ConstIterator pos) noexcept {
        ...
        Node* tmp_node = (pos.node_->next_node)->next_node;
